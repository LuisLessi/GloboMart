...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{$GET_HOME}"><img src="/view/images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="{$PAG_MINHACONTA}"><i class="fa fa-user"></i> Account</a></li>
    ...
    <script src="/view/temas/js/jquery.js"></script>
	<script src="/view/temas/js/bootstrap.min.js"></script>
	<script src="/view/temas/js/jquery.scrollUp.min.js"></script>
	<script src="/view/temas/js/price-range.js"></script>
    <script src="/view/temas/js/jquery.prettyPhoto.js"></script>
    <script src="/view/temas/js/main.js"></script>
</body>
</html>